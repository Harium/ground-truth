...
import examples.apps.skybox.SplittedImagesSkybox;
import examples.apps.tiles.TileAlphaTextureFloor;
...
public class MainTile extends Propan {
  ...
  public ApplicationGL startApplication() {
    ...
    return new TileAlphaTextureFloor(w, h);
    //return new SplittedImagesSkybox(w, h);
  }
}
