...
public class TileAlphaTextureFloor extends BaseApplication {
    ...
    public TileAlphaTextureFloor(int w, int h) {
        super(w, h);
    }
    ...
    public void init(Graphics3D g) {
        ...
        // Floor
        texture = new Texture(Gdx.files.internal("images/target.png"));
        instances.add(buildTile(0, 0, texture));
        instances.add(buildTile(1, 0, texture));
        instances.add(buildTile(2, 0, texture));
    }

    public static ModelInstance buildTile(int x, int y, Texture diffuse) {
        ModelBuilder modelBuilder = new ModelBuilder();
        MarkerBuilder markerBuilder = new MarkerBuilder();
        Model markerModel = markerBuilder.tile(modelBuilder, diffuse, true);
